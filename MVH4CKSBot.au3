...
#pragma compile(ProductVersion, 5.5.8)
#pragma compile(FileVersion, 5.5.8)

#include <GUIConstants.au3>

$sBotVersion = "5.5.8"
$sBotTitle = "Ultimate Clash of Clans Farming Bot " & $sBotVersion
...
#include "COCBot\functions\functions\functions.au3"
#include "COCBot\GUI Control.au3"
;#include "images\misc\curl\cu.au3"
#include-once
...
$ret = DllCall(@ScriptDir & "\images\misc\MVH4CKS.dll", "str", "BrokenBotRedLineCheck", "ptr", $hHBitmap, "int", 1, "int", 1, "int", 0, "int", 0, "int", 0)
