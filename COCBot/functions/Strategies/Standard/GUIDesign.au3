Func Standard_LoadGUI()
	...
	$RedConditions = GUICtrlCreateGroup(GetLangText("RedConditions"), 18, 315, 397, 120)
	...
	GUICtrlSetLimit(-1, 2)
	$lblRedNukePercent = GUICtrlCreateLabel(GetLangText("lblRedNukePercent"), 220, 340, 120, 20)
	Global $txtRedNukePercent = GUICtrlCreateInput("5", 350, 340, 50, 21, BitOR($ES_CENTER, $ES_NUMBER))
	GUICtrlSetLimit(-1, 2)
	; -- end of session
	#Cs
