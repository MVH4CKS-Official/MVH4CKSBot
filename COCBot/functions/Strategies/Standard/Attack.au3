...
Func Standard_Attack($AttackMethod = 1)
	...
	Else
		...
		Else
			If $AttackMethod = 0 Then
				Switch _GUICtrlComboBox_GetCurSel($cmbDeadDeploy)
					Case 0 ;Single sides ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
						SetLog(GetLangText("msgSingleSide"), $PURPLE)
						$nbSides = 1
					Case 1 ;Two sides ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
						SetLog(GetLangText("msgTwoSides"), $PURPLE)
						$nbSides = 2
					Case 2 ;Three sides ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
						SetLog(GetLangText("msgThreeSides"), $PURPLE)
						$nbSides = 3
					Case 3 ;Four sides ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
						SetLog(GetLangText("msgAllSides"), $PURPLE)
						$nbSides = 4
					Case 4
						SetLog(GetLangText("msgMixedMode"), $PURPLE)
						$nbSides = 4
						$mixedMode = True
				EndSwitch
			Else
				...
				EndSwitch
			EndIf
			If ($OuterQuad And $attackTH = 1) Then SetLog(GetLangText("msgLimitedTH"), $PURPLE)
		...
		If ($SpellQty >= GUICtrlRead($txtSpellNumber)) And Number($Resources[4]) >= Number(GUICtrlRead($txtDENukeLimit)) And IsChecked($chkNukeAttacking) Then
			SetLog(GetLangText("msgNuking"), $COLOR_RED)
			Standard_DropNukes()
		EndIf
